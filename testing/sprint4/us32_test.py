...
class Tests(unittest.TestCase):
    ...
    txtfiles = [
        git_utils.abs_path('/testing/sprint3/us32_01.txt'),
        git_utils.abs_path('/testing/sprint3/us32_02.txt'),
        git_utils.abs_path('/testing/sprint3/us32_original.txt')
    ]
    results = []
    ...
    def test01(self): 
        ...
        result = compare.compare(us32.list_multiple_births(indivs, families, print_table=False), result_file, 'US32')
        self.results += result
